...
class Game:
    ...
    def trivia(self):
        ...
        if self.points > data['Highscore']['score']:
            ...
            self.highscore_text = font.render(f"Du fikk til sammen {self.points} poeng! Highscoren er det {username} som har med {highscore} poeng.", True, RED)
